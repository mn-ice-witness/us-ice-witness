...
- Single no-news-media social media posts
...
5. **Add ALL discovered sources** - Even no-news-media links should be added to incident files
...
**CRITICAL:** When researching, add ALL discovered sources to incident files, even if no-news-media:
