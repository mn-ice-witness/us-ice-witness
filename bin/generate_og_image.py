...
Usage: python-main bin/generate_og_image.py <folder>
Example: python-main bin/generate_og_image.py docs/og-image
"""
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python-main bin/generate_og_image.py <folder>")
        print("Example: python-main bin/generate_og_image.py docs/og-image")
        sys.exit(1)
